...
async function main() {
  ...
  try {
    ...
    ok('手機下載按鈕可用', (firstDownload.hrefPrefix.indexOf('blob:') === 0 || firstDownload.hrefPrefix.indexOf('data:image/png') === 0) && !!firstDownload.download, JSON.stringify(firstDownload));
