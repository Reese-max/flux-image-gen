(() => {
  ...
  function h(e = "default") {
    return {
      createTx(r) {
        const f = /* @__PURE__ */ new Map(), n = r != null ? r : self;
  ...
  var l2 = (...e) => e.reduce((t, n) => {
    if (n === void 0)
      return t;
    if (Array.isArray(n))
      throw new TypeError("Arguments provided to ts-deepmerge must be objects, not arrays.");
    return Object.keys(n).forEach((r) => {
      Y.has(r) || (Array.isArray(t[r]) && Array.isArray(n[r]) ? t[r] = l2.options.mergeArrays ? l2.options.uniqueArrayItems ? Array.from(new Set(t[r].concat(n[r]))) : [...t[r], ...n[r]] : n[r] : y(t[r]) && y(n[r]) ? t[r] = l2(t[r], n[r]) : !y(t[r]) && y(n[r]) ? t[r] = l2(n[r], void 0) : t[r] = n[r] === void 0 ? l2.options.allowUndefinedOverrides ? n[r] : t[r] : n[r]);
    }), t;
  }, {});
  var S = {
  ...
  l2.options = S;
  l2.withOptions = (e, ...t) => {
    l2.options = Object.assign(Object.assign({}, S), e);
    const n = l2(...t);
    return l2.options = S, n;
  };
  var X = 1 * 1024 * 1024;
  var Z = 2;
  var H = 200;
  ...
  async function D(e, t, n) {
    ...
    ie(e);
    const r = (_a = n == null ? void 0 : n.maxRetries) != null ? _a : Z, i = (_b = n == null ? void 0 : n.initialRetryDelayMs) != null ? _b : H, o = (_c = n == null ? void 0 : n.maxRetryDelayMs) != null ? _c : K, _ = (_d = n == null ? void 0 : n.maxRetryAfterMs) != null ? _d : Q, a = (_e2 = n == null ? void 0 : n.isRetryableStatus) != null ? _e2 : ee, s = (_f = n == null ? void 0 : n.isRetryableError) != null ? _f : (() => true), c = (_g = n == null ? void 0 : n.fetch) != null ? _g : fetch, u = (f) => ne(f, i, o);
    for (let f = 0; ; f++) {
      let d;
      try {
        d = await c(e, t);
        ...
        const g2 = b instanceof Error ? b.message : String(b);
        throw new Error(`Network error fetching ${e}: ${g2}`, {
          cause: b
        });
      }
      if (!d.ok) {
        if (a(d.status)) {
          const g2 = re(d.headers.get("retry-after"));
          if (g2 !== null) {
            if (g2 > _)
              throw new Error(`Failed to fetch ${e}: server requested a Retry-After delay of ${Math.ceil(g2 / 1e3)}s, which exceeds the maximum allowed delay of ${_ / 1e3}s`);
            if (f < r) {
              await new Promise((m) => setTimeout(m, Math.max(g2, 0)));
              continue;
            }
  ...
  async function x(e, t) {
    var _a;
    const n = (_a = t == null ? void 0 : t.maxResponseBytes) != null ? _a : X, r = await D(e, void 0, t), i = r.headers.get("content-length");
  ...
  async function w(e, t, n) {
    const r = t ? l2(e != null ? e : {}, t) : e;
    if (!r)
      return;
    const i = l2(_e, r), o = [];
    return i.trust && o.push(M2(i.trust, n)), i.cawgTrust && o.push(M2(i.cawgTrust, n)), await Promise.all(o), JSON.stringify(E(i));
  }
  var ae = [
    "userAnchors",
    "trustAnchors",
  ...
  typeof FinalizationRegistry > "u" || new FinalizationRegistry((e) => h2.__wbg_wasmbuilder_free(e, 1));
  typeof FinalizationRegistry > "u" || new FinalizationRegistry((e) => h2.__wbg_wasmreader_free(e, 1));
  typeof FinalizationRegistry > "u" || new FinalizationRegistry((e) => h2.__wbg_wasmsigner_free(e, 1));
  typeof FinalizationRegistry > "u" || new FinalizationRegistry((e) => h2.__wbindgen_destroy_closure(e.a, e.b));
  ...
  var h2;
  var de = "sha512-f5DJqRWk41o9U7OZj4f51jauyy27oA+SzzqdtxAMnYovlPtlukFg71289iXWXXs3YTGt0BuUOd7cqlwZ3kLNeg==";
  async function O(e) {
    const { alg: t } = e;
    return {
  ...
  function $(e) {
    var _a;
    return ((_a = e.assertions) != null ? _a : []).filter((t) => t.label.startsWith("c2pa.actions")).map((t) => {
      var _a2;
      const n = t.data;
      return (_a2 = n == null ? void 0 : n.actions) != null ? _a2 : [];
    });
  }
  function be(e, t) {
  ...
  function R(e, t, n) {
    ...
    return {
      ...
      async filterIngredients(i) {
        var _a;
        const a = ((_a = (await r.builder_getDefinition(t)).ingredients) != null ? _a : []).reduce((s, c, u) => (i(c) && s.push(u), s), []);
        await r.builder_filterIngredientsAt(t, a);
      },
      async filterActionsAndIngredients(i, o) {
        var _a;
        const _ = await r.builder_getDefinition(t), s = U(_).reduce((f, d, b) => (i(d) && f.push(b), f), []), u = ((_a = _.ingredients) != null ? _a : []).reduce(
  ...
  // src/c2pa-entry.js
  globalThis.FluxC2paWeb = { createC2pa: Se };
})();
